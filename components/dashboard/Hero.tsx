...
export function Hero({ onStartMatch, onTriggerAudit, onViewDemo }: HeroProps) {
  return (
    <section className='rounded-3xl border border-slate-200 bg-white p-8 shadow-sm'>
      ...
      <div className='mt-4 flex flex-wrap gap-3'>
        ...
        <Button className='bg-tea' onClick={onTriggerAudit}>Trigger Emergency Tea Audit</Button>
        <Button className='bg-pitch' onClick={onViewDemo}>View Demo Dashboard</Button>
      </div>
    </section>
  );
}
